...
test.run = function(tool.vec=c("sf", "ppc", "bpcs", "cupc"))
{
  tool.vec = c("cupc")
  data.id.vec = c("hepar2", "alarm", "win95pts", "hailfinder",
                  "link", "munin", "pigs", "win95pts",
                  "random5kf2", "random5kf3", "random5kf4")
  # data.id.vec = c("hepar2", "alarm", "win95pts")
  # data.id.vec = c("pathfinder")
